...
import { Connection, SharedWorkerConnectionManager } from '@converse/headless/connection.js';
...
_converse.initConnection = async function (domain) {
    ...
    if (_converse.isTestEnv()) {
        ...
        Conn = api.settings.get('use_service_worker') ? SharedWorkerConnectionManager : Connection;
    }
